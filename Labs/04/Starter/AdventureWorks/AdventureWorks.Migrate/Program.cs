...
namespace AdventureWorks.Migrate
{
    class Program
    {
        ...
        private const string cosmosDBConnectionString = "AccountEndpoint=https://polycosmosjbd.documents.azure.com:443/;AccountKey=VMXgKd8bdV8lNo25AVzo67Ujvum4Wl1b2KDIsAzPEnQVdCIcPSDWQkyKcvZLez9VUoi22TbDsRUGa3LXcwedQA==;";
        public static async Task Main(string[] args)
        {
            ...
            {
                ItemResponse<Model> document = await container.UpsertItemAsync<SELECT VALUE COUNT(1) FROM models>(item);
